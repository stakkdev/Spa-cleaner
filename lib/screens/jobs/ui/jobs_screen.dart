...
class _JobListState extends State<JobList> with AutomaticKeepAliveClientMixin<JobList>  {
  JobModel jobModel;
  JobBloc jobBloc;
  ...
  void initState(){
    ...
    WidgetsBinding.instance.addPostFrameCallback((timestamp) {
      ...
      if(jobModel== null)getJobList(Constants.TodayJob);
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          child: jobModel== null ? noJobText() :
          RefreshIndicator(
            onRefresh: () async{
              getJobList(Constants.TodayJob);
            },
  ...
  Widget noJobText() {
    return Center(
      child: Column(
          ...
          Text(showNoJobToday ? "No jobs for today." :"Please wait ..."),
          ],),
    );
  }
